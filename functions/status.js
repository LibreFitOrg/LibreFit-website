...
function getFriendlyStatus(status) {
  const statuses = {
    ...
    'paid_partially': { title: 'Partially Paid', description: 'The donation was completed, but the amount received was lower than requested. Thank you for your support!' },
